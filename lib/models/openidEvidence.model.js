...
exports.CheckMethod = exports.TypePhysicalDocument = exports.TypeVerificationMethod = void 0;
 ...
 */
var TypeVerificationMethod;
(function (TypeVerificationMethod) {
    TypeVerificationMethod["PhysicalInPerson"] = "pipp";
    TypeVerificationMethod["SupervisedRemoteInPerson"] = "sripp";
    TypeVerificationMethod["OnlineElectronicID"] = "eid";
    TypeVerificationMethod["UnsupervisedRemoteInPerson"] = "uripp";
    TypeVerificationMethod["ElectronicallyOnsite"] = "onsite"; // 	https://openid.net/verification_method/onsite 	Electronically onsite reading the document’s chip using an authorization certificate and card access number.    
})(TypeVerificationMethod = exports.TypeVerificationMethod || (exports.TypeVerificationMethod = {}));
var TypePhysicalDocument;
(function (TypePhysicalDocument) {
    TypePhysicalDocument["IDcard"] = "idcard";
    TypePhysicalDocument["Passport"] = "passport";
    TypePhysicalDocument["DrivingLicense"] = "driving_permit";
    TypePhysicalDocument["ResidencePermit"] = "residence_permit";
    TypePhysicalDocument["TaxStatement"] = "tax_statement";
    TypePhysicalDocument["SocialSecurityStatement"] = "social_security_statement";
    TypePhysicalDocument["BanSstatement"] = "bank_statement";
    TypePhysicalDocument["UtilityStatement"] = "utility_statement";
    TypePhysicalDocument["EducationCertificate"] = "education_certificate";
    TypePhysicalDocument["Visa"] = "visa";
    TypePhysicalDocument["MilitaryID"] = "military_id"; // 	https://openid.net/document/military_id 	An official military identity document issued by a country's government to its service personnel.
})(TypePhysicalDocument = exports.TypePhysicalDocument || (exports.TypePhysicalDocument = {}));
var CheckMethod;
(function (CheckMethod) {
    CheckMethod["vpip"] = "vpip";
    CheckMethod["vpiruv"] = "vpiruv";
    CheckMethod["vri"] = "vri";
    CheckMethod["vdig"] = "vdig";
    CheckMethod["vcrypt"] = "vcrypt";
    CheckMethod["data"] = "data";
    CheckMethod["auth"] = "auth";
    CheckMethod["token"] = "token";
    CheckMethod["kbv"] = "kbv";
    CheckMethod["pvp"] = "pvp";
    CheckMethod["pvr"] = "pvr";
    CheckMethod["bvp"] = "bvp";
    CheckMethod["bvr"] = "bvr";
})(CheckMethod = exports.CheckMethod || (exports.CheckMethod = {}));
